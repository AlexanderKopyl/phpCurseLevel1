...
<main>
    ...
    <?php if (array_key_exists($_GET['product_id'], $array_product)){?>
    <section class="lot-item container">
        <h2><?php echo $array_product[$_GET['product_id']]['Name']?></h2>
        <div class="lot-item__content">
            <div class="lot-item__left">
                <div class="lot-item__image">
                    <img src="../<?php echo $array_product[$_GET['product_id']]['url']?>" width="730" height="548" alt="Сноуборд">
                </div>
                <p class="lot-item__category">Категория: <span><?php echo $array_product[$_GET['product_id']]['category']?></span></p>
                <p class="lot-item__description">

                    <?php if($array_product[$_GET['product_id']]['description']) {?>
                    <?php echo $array_product[$_GET['product_id']]['description'];?>
                    <?php } else {?>
    ...
    <? } else {?>
    <section class="lot-item container">
        <h1>Такого товара не существует Ошибка 404</h1>
    </section>
    <?}?>
